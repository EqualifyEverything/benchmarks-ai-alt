You are reviewing batch 01 of the functional image corpus for the AI alt text
benchmark.
...
Read /Users/uic-b3b/Repos/benchmarks-ai-alt/projects/corpus-construction/directives/review.md and follow it exactly.

Your input is review/batch-01-input.jsonl, which holds 30 item(s), one
per line. Write your verdicts to review/batch-01.jsonl, one per input item.
...
you have written review/batch-01.jsonl.
