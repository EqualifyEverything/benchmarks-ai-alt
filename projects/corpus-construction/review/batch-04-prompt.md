You are reviewing batch 04 of the functional image corpus for the AI alt text
benchmark.
...
Your input is review/batch-04-input.jsonl, which holds 30 item(s), one
per line. Write your verdicts to review/batch-04.jsonl, one per input item.
...
you have written review/batch-04.jsonl.
